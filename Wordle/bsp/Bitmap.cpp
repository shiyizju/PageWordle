...
void Bitmap::splitNode(BSPNode* node)
{
...
void Bitmap::initNodeWithPixelData(BSPNode* node, const unsigned char* pixelData, int widthStep)
{
...
EnumDataFlag Bitmap::_dataFlagOfRectWithPixelData(MIRect rect, const unsigned char* pixelData, int widthStep)
{
